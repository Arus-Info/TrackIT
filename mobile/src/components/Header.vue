        ...
        <div class="bg-gradient-to-r from-[#4A6BB6] to-[#7F9DE0] h-16 flex items-center justify-between"
            ...
            <div class="pr-4">
                ...
                <div v-if="session.isLoggedIn"
                    class="bg-[#EAF0F4] w-11 h-11 rounded-[44px] flex items-center justify-center">
                    <PersonIcon class=" h-7 w-7"></PersonIcon>
                </div>
            </div>
        </div>
        <div v-if="session.isLoggedIn" class=" pt-4 flex justify-between pl-5 pr-6 pb-3 bg-white">
